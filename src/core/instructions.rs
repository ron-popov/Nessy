...
pub fn get_instruction_set() -> HashMap<u8, Instruction> {
    ...
    map.insert(0x43, Instruction{opcode: 0x43, name: "SRE".to_string(), bytes:2, mode:"(Indirect,X)".to_string()});
    map.insert(0x47, Instruction{opcode: 0x47, name: "SRE".to_string(), bytes:2, mode:"ZeroPage".to_string()});
    map.insert(0x4F, Instruction{opcode: 0x4F, name: "SRE".to_string(), bytes:3, mode:"Absolute".to_string()});
    map.insert(0x53, Instruction{opcode: 0x53, name: "SRE".to_string(), bytes:2, mode:"(Indirect),Y".to_string()});
    map.insert(0x57, Instruction{opcode: 0x57, name: "SRE".to_string(), bytes:2, mode:"ZeroPage,X".to_string()});
    map.insert(0x5B, Instruction{opcode: 0x5B, name: "SRE".to_string(), bytes:3, mode:"Absolute,Y".to_string()});
    map.insert(0x5F, Instruction{opcode: 0x5F, name: "SRE".to_string(), bytes:3, mode:"Absolute,X".to_string()});

    map.insert(0xE3, Instruction{opcode: 0xE3, name: "ISC".to_string(), bytes:2, mode:"(Indirect,X)".to_string()});
    map.insert(0xE7, Instruction{opcode: 0xE7, name: "ISC".to_string(), bytes:2, mode:"ZeroPage".to_string()});
    map.insert(0xEE, Instruction{opcode: 0xEE, name: "ISC".to_string(), bytes:3, mode:"Absolute".to_string()});
    map.insert(0xF3, Instruction{opcode: 0xF3, name: "ISC".to_string(), bytes:2, mode:"(Indirect),Y".to_string()});
    map.insert(0xF7, Instruction{opcode: 0xF7, name: "ISC".to_string(), bytes:2, mode:"ZeroPage,X".to_string()});
    map.insert(0xFB, Instruction{opcode: 0xFB, name: "ISC".to_string(), bytes:3, mode:"Absolute,Y".to_string()});
    map.insert(0xFF, Instruction{opcode: 0xFF, name: "ISC".to_string(), bytes:3, mode:"Absolute,X".to_string()});

    map.insert(0x03, Instruction{opcode: 0x03, name: "SLO".to_string(), bytes:2, mode:"(Indirect,X)".to_string()});
    map.insert(0x07, Instruction{opcode: 0x07, name: "SLO".to_string(), bytes:2, mode:"ZeroPage".to_string()});
    map.insert(0x0F, Instruction{opcode: 0x0F, name: "SLO".to_string(), bytes:3, mode:"Absolute".to_string()});
    map.insert(0x13, Instruction{opcode: 0x13, name: "SLO".to_string(), bytes:2, mode:"(Indirect),Y".to_string()});
    map.insert(0x17, Instruction{opcode: 0x17, name: "SLO".to_string(), bytes:2, mode:"ZeroPage,X".to_string()});
